...
from typing import Union, TYPE_CHECKING, List, Tuple, Dict, Set

if TYPE_CHECKING:
    from hepqpr.qallse.fast.data_wrapper import DataWrapper
...
from .data_structures import Doublet, Triplet, Quadruplet, Hit
from .utils import tracks_to_xplets_numba
from ..type_alias import TQubo, TDimodSample, TXplet
